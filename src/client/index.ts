...
import { MeResource } from "src/lib/modules/me/resource";
...
import { RefundsResource } from "src/lib/modules/refunds/resource";
...
import { TaskCommentsResource } from "src/lib/modules/task-comments/resource";
...
> {
  ...
  readonly taskComments: TaskCommentsResource;
  ...
  constructor(options: AssemblyKitOptions) {
    ...
    this.taskComments = new TaskCommentsResource(ctx);
